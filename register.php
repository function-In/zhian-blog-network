...
<head>
    ...
    <script src="./admin/public/scripts/vue.js"></script>
    <script src="./admin/public/scripts/axios.min.js"></script>
    <script src="./admin/public/scripts/jquery-3.5.1.min.js"></script>
    <!-- Element-Ui -->
    ...
    <div id="app" class="app">
        ...
        <div class="content">
            <el-form :model="table" :rules="rules" ref="table" label-width="100px">
                <form action="./admin/pages/user_register.php" method="post" name="formData" id="formData" enctype="multipart/form-data">
                    <div class="viso">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="onSubmit('table')">开始注册新账号</el-button>
                        <el-button type="cannel" @click="onCancel(1)">已有账号？去登陆</el-button>
                        <el-button type="cannel" @click="onCancel(2)">返回首页</el-button>
                    </el-form-item>
                </form>
            </el-form>
        </div>
